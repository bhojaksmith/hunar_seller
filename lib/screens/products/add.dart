                  ...
                  child: ClipRRect(
                    ...
                    child: RaisedButton(
                        ...
                        onPressed: () {
                          ...
                          //     .instance.collection('testSeller');
                          // ignore: deprecated_member_use
                          // only use set data for inserting the first time
                         // collectionReference.doc(uid).collection('products').doc().set(testData);
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => AddProduct2(productName:productName,productPrice:productPrice,productURL:_uploadedFileURL)),
                          );
                        }
                    ),
                  )
